...
- Si el cliente hace una pregunta que NO es sobre productos (ej: horarios, ubicación, pagos, delivery), NO respondas con productos. Responde solo sobre el tema consultado.`;
}
